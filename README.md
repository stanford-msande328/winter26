...
|                   | Time                       | Location       |
|-------------------|----------------------------|-----------     |
| Vasilis Syrgkanis | Monday 5.00-6.00pm         | Huang 252      |
...
* 70% project (35% literature review, 35% final report)
  - Proposal Due: Jan 30
  - Literature Review Due: Feb 28
  - Final Report Due: March 20
...
* Textbook: [Foundations of Causal ML](https://www.dropbox.com/scl/fi/a4t5pqmmauxvfa2j32hya/MSANE328_CS328.pdf?rlkey=bqe5sc1nre4s7ooartpmldmls&e=1&st=wjm7w8dt&dl=0)
...
Course lecture notes are [available online](https://www.dropbox.com/scl/fi/a4t5pqmmauxvfa2j32hya/MSANE328_CS328.pdf?rlkey=bqe5sc1nre4s7ooartpmldmls&e=1&st=wjm7w8dt&dl=0). Any feedback on the course textbook will be greatly appreciated as we iterate over the material. These are the primary material for the course.  In addition, you may find it helpful to have the following textbooks on hand. I’m not requiring them, because they are available online, and we will not be linearly working our way through any of them. 
...
**Section 3:** Identification with Unobserved Confounding beyond DAGs
...
**Section 4:** Semi-Parametric Inference and Neyman Orthogonality
...
**Section 5:** Identification and Inference in Dynamic Regimes
...
**Section 6:** Identification and Inference with Proxies and Instruments

Auto-DML for proximal inference and non-parametric instrumental variable regression


**Section 7:** Orthogonal Statistical Learning Theory for Heterogeneous Effects

Orthogonal statistical learning theory. Localized rademacher complexities and generalization bounds.


**Section 8:** Non-Parametric Inference for Heterogeneous Effects
...
**Section 9:** Non-Parametric Learning and Conditional Moment Restrictions
